...
if (isset($_POST['btn_publish'])) {
    ...
    if (count($message)==0) {
    	...
    	echo "<script>alert('Data Berhasil Ditambah'); window.location = 'loker.php'</script>";
    }
							...
							<form action="" method="post" enctype="multipart/form-data">
								<div class="col-sm-8">
									<div class="form-group">
										<input type="text" class="form-control" name="judul" placeholder="Lowongan Perkejaan" value="<?php echo $var_judul; ?>">
									</div>
									<div class="form-group">
								...
								<div class="col-sm-12">
									<a href="loker.php" class="btn btn-danger btn-sm">
