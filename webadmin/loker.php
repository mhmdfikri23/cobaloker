		...
		<div class="col-lg-10 main-content">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="row">
						<div class="col-md-12">
							<h2 class="page-header"><i class="fa fa-newspaper-o"></i> Lowongan Pekerjaan</h2>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
							<a href="tambah-loker.php" class="btn btn-sm btn-primary">
								<i class="fa fa-plus-circle"></i> Tambah Lowongan Pekerjaan
							</a>
							<div class="clear"></div>
								...
								<?php while ($news_list = $qry->fetch_assoc()) { ?>
									<tr>
										...
										<td align="center">
											...
											<a href="edit-loker.php?id=<?=$news_list['id_berita']?>" class="btn btn-sm btn-success">
												<i class="fa fa-edit"></i>
											</a>
											<a onclick="return confirm('Anda Yakin Ingin Menghapus Data Ini?');" href="hapus-loker.php?id=<?=$news_list['id_berita']?>" class="btn btn-sm btn-danger">
						...
						<div class="col-md-12">
							...
							<?php if ($noPage > 1) { ?>
								...
								<li>
									<a href="<?php echo "loker.php?p=".($noPage-1);?>">
